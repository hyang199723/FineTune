...
fn = wk_dir + "Labels/SolarPanelPNG/" + "Frame_001_1.png"
ref_mask = cv2.imread(fn)
ref_mask = cv2.cvtColor(ref_mask, cv2.COLOR_BGR2RGB)

fn = wk_dir + "Data/SolarPanel/" + "Frame_175.png"
...
k = 10
topk_xy_i, topk_label_i, last_xy_i, last_label_i = point_selection(sim, topk=k)
